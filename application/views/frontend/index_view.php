							...
							<form method="POST" action="<?php echo base_url(); ?>checkout">
									...
									<div class="col-md-4 personal-info">
						        		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
						        			<label>*</label>
						                    <input type="text" class="form-control validate[required, custom[onlyLetterSp]]" placeholder="Nombre(s)" id="nombres_<?php echo $key; ?>" name="nombres" />
						                </div>
						                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
						                	<label>*</label>
						                    <input type="text" class="form-control validate[required, custom[onlyLetterSp]]" placeholder="Apellido(s)" id="apellido_paterno_<?php echo $key; ?>" name="apellido_paterno" />
						                </div>
						                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
						                	<label>*</label>
					                ...
					                <div class="col-xs-12 col-sm-12 col-md-4 ctn-doc">
										...
										<div class="cont-select">
								                <select name="monto_total" class="validate[required]" onchange="javascript:validar_otro_monto(this, <?php echo $key; ?>);" id="monto_total_<?php echo $key; ?>">
													...
													<option data-apoyo="" value="" class="color-2">DNI</option>
								                    <option data-apoyo="" value="" class="color-2">Pasaporte</option>
													<option data-apoyo="" value="" class="color-2">CE</option>
								                	<option value="1" data-apoyo="0" class="color-2">Otro</option>
								                </select>
								            </div>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-12 reset-total">
