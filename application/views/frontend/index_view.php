			...
			<div class="col-xs-12 col-sm-12 col-md-12 cont-rsp-padd">
				<div class="col-xs-12 col-sm-12 col-md-10 ctn-formulario">
					...
					<ul class="nav nav-tabs">
						<li>
							<a data-toggle="tab" href="#unete" class="unete">
								<?php echo $campania['unete']; ?>
							</a>
						</li>
					</ul>
					...
					<div class="tab-content bg-formulario">
							...
							<form method="POST" action="<?php echo base_url(); ?>unete">
								<div class="personal-info col-md-6">
									<div class="row">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
											<input type="text" class="form-control validate[custom[onlyLetterSp]]"
										...
										<div class="col-xs-8 col-sm-8 col-md-8 reset-total">
											<div class="col-xs-4 col-sm-4 col-md-4 reset-total">
												<label class="container-check">
													DNI
													<input type="radio" class="validate[required]" id="dni" value="1"
														   name="tipo_documento"
											...
											<div class="col-xs-4 col-sm-4 col-md-4 reset-total">
												<label class="container-check">
													Otro
													<input type="radio" class="validate[required]" id="otro" value="3"
														   name="tipo_documento"
														   onclick="javascript:validar_documento(this);">
													<span class="checkmark"></span>
												</label>
								...
								<div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 form-group cont-camp reset-total">
									...
									<div class="col-xs-6 col-sm-6 col-md-8 term-cond">
										<label class="container-check">
											Acepto los
											<input type="checkbox" class="validate[required]" name="terminos" value="1"
												   id="terminos"/>
											<span class="checkmark"></span>
										</label>
						...
						<?php foreach ($tipos as $key => $value): ?>
							<div id="section_<?php echo $value; ?>"
								 class="tab-pane fade<?php echo ($key == 2) ? ' in active' : ''; ?>">
								<form method="POST" action="<?php echo base_url(); ?>checkout"
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<label class="container-check">
													...
													<input type="radio" name="tipo_moneda"
														   ...
														   onclick="javascript:configurar_moneda('PEN');" value="PEN"
														   checked="checked"/>
													<span class="checkmark"></span>
												</label>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<label class="container-check">
													...
													<input type="radio" name="tipo_moneda"
														   ...
														   onclick="javascript:configurar_moneda('USD');" value="USD"/>
													<span class="checkmark"></span>
												</label>
											</div>
										</div>
												...
												<div class="col-md-12 ctn-doc reset-total">
													...
													<div class="form-group camp-obli">
														...
														<?php if ($campania['monto_minimo_' . $key] > 0): ?>
															<p class="monto_minimo monto_minimo_PEN<?php echo ($campania['monto_minimo_1'] > 0) ? '' : ' hidden'; ?>">
																Monto
																mínimo <?php echo $campania['monto_minimo_1']; ?></p>
															<p class="monto_minimo monto_minimo_USD<?php echo ($campania['monto_minimo_2'] > 0) ? '' : ' hidden'; ?>">
																Monto
																mínimo <?php echo $campania['monto_minimo_2']; ?></p>
														<?php endif; ?>
													</div>
												</div>
											</div>
									...
									<div class="col-md-4 personal-info">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
											...
											<input type="text"
												   ...
												   id="apellido_paterno_<?php echo $key; ?>" name="apellido_paterno"/>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
											<input type="text" class="form-control validate[custom[onlyLetterSp]]"
												   placeholder="Apellido Materno"
												   id="apellido_materno_<?php echo $key; ?>" name="apellido_materno"/>
										</div>
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group reset-total">
											<label>*</label>
											<input type="text" class="form-control validate[required, custom[email]]"
									...
									<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 form-group cont-camp reset-total">
										...
										<div class="col-xs-6 col-sm-6 col-md-4 camp-obli">
											<button type="button" onclick="javascript:pagar(this);" class="btn-primary">
												Donar
											</button>
											<p>*Campos obligatorios</p>
										</div>
